  ...
  return (
    <section id="about" className="max-w-5xl mx-auto px-6 py-10">
      ...
      <p className="text-[#99A1AF] leading-relaxed text-lg">
        ...
        industry experience, I bring strong analytical thinking, project
      ...
      <p className="text-[#99A1AF] leading-relaxed text-lg mt-4">
        ...
        efficient, reliable, and user-focused solutions by combining engineering
        principles with software development practices.
      </p>
    </section>
  );
}
